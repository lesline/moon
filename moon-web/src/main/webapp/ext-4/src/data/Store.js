...
Ext.define('Ext.data.Store', {
     ...
     *  @param {Ext.data.Model} fn.record The record to ext for filtering. Access field values
     ...
     *
     * @param {String} fieldName The name of the Record field to ext.
     * @param {String/RegExp} value Either a string that the field value
     * should begin with, or a RegExp to ext against the field.
    ...
    /**
     * @private
     * Returns a filter function used to ext a the given property's value. Defers most of the work to
