...
(function() {
    ...
    Ext.apply(Ext, {
        ...
        /**
         * A zero length string which will pass a truth ext. Useful for passing to methods
         * which use a truth ext to reject <i>falsy</i> values where a string value must be cleared.
         */
    ...
    Ext.apply(Ext, {
         ...
         *
         * @param {Object} value The value to ext
         ...
         *
         * @param {Object} target The target to ext
         * @return {Boolean}
         * @method
         */
         ...
         * @param {Object} object The object to ext
         * @return {Boolean}
         */
