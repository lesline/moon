 ...
 *     });
 *
 * The following ext will find panels with their `ownProperty` collapsed being equal to
 ...
 * *has* a title first, before running regex ext on it.
 *
 * ## Query examples
 *
...
Ext.define('Ext.ComponentQuery', {
        ...
        filterByAttribute = function(items, property, operator, compareTo) {
            ...
            for (; i < length; i++) {
                ...
                if (!mustBeOwnProperty || candidate.hasOwnProperty(property)) {
                    ...
                    // pull out property value to ext
    ...
    Ext.apply(this, {
         ...
         * @param {Ext.Component} component The Component to ext
        ...
        parse: function(selector) {
            ...
            while (selector && lastSelector !== selector) {
                ...
                if (modeMatch[1]) { // Assignment, and ext for truthiness!
                    operations.push({
