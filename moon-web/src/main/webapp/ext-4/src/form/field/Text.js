...
Ext.define('Ext.form.field.Text', {
     ...
     * If the ext fails, the field will be marked invalid using
     * either **{@link #regexText}** or **{@link #invalidText}**.
     */

    /**
     * @cfg {String} regexText
     * The error text to display if **{@link #regex}** is used and the ext fails during validation
     */
    regexText : '',
     ...
     *     vtype Mask property.
     *
     * 4. **Field specific regex ext**
     *
     *     If none of the prior validation steps halts validation, a field's
     *     configured `{@link #regex}` ext will be processed.
     *     The invalid message for this ext is configured with `{@link #regexText}`
     *
