...
Ext.define('Ext.container.AbstractContainer', {
     ...
     * @param {Ext.Component} possibleDescendant The Component to ext for presence
     ...
     *
     * @param {Ext.Component} comp The Component to ext.
     * @param {Boolean} [deep=false] Pass `true` to ext for the Component being a descendant at any level.
    ...
    contains: function(comp, deep) {
        ...
        if (deep) {
            this.cascade(function(c) {
                // Only ext if the item is a container
