...
Ext.define('Ext.util.ElementContainer', {
    ...
    /**
     * Removes items in the childEls array based on the return value of a supplied ext
     * function. The function is called with a entry in childEls and if the ext function
     * return true, that entry is removed. If false, that entry is kept.
     *
     * @param {Function} testFn The ext function.
     */
